        ...
        <div class="topbar-nav">
          ...
          <div class="login">
            <template v-if="user && user.name">
              <div
                class="li user"
                :class="{ 'user-active': userActive }"
                @mouseenter="userMenu"
                @mouseleave="userMenuOut"
              >
                <NuxtLink to="/user/portal" class="user-name"
                  ><span>{{
                    user.name ? user.name : user.email
                  }}</span
                  ><i class="iconfont mallservice-xia"></i
                ></NuxtLink>
                <el-collapse-transition>
                  <div class="user-menu-wrapper" v-show="userActive">
                    <ul class="user-menu">
                      <li>
                        <NuxtLink class="a" to="/user/portal"
                          >个人中心</NuxtLink
                        >
                      </li>
                      <li>
                        <NuxtLink class="a" to="/user/collect"
                          >我的收藏</NuxtLink
                        >
                      </li>
            ...
            <div
              class="li cart"
              :class="{ on: shoppingCart.length > 0 }"
              @mouseenter="userCart"
                  ...
                  <i
                    ...
                    :class="
                      shoppingCart.length > 0
                        ? 'mallservice-gouwuche1'
                        : 'mallservice-gouwuche'
                    "
                  ></i
                  >购物车({{ $nuxt.$store.state.shoppingCartNumber }})
                </div></NuxtLink
              >
              <el-collapse-transition>
                <div
                ...
                >
                  <template v-if="shoppingCart.length > 0">
                    ...
                    <div class="cart-total">
                      <div class="number">
                        <div class="name">
                          共 {{ $nuxt.$store.state.shoppingCartNumber }} 件商品
                        </div>
                        <div class="price">
        ...
        <div class="nav">
          ...
          >
            <el-form-item prop="keyword">
              <el-input
                placeholder=""
                v-model="searchRuleForm.keyword"
