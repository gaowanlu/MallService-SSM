<template>
  <div class="box" v-loading="loading">
    ...
    <div class="indent-box">
      <div class="li">
        <div class="icon bg-blue"><i class="iconfont mallservice-icon-"></i></div>
        <div class="describe">
      ...
      <div class="li">
        <div class="icon bg-purple"><i class="iconfont mallservice-daifahuo"></i></div>
        <div class="describe">
      ...
      <div class="li">
        <div class="icon bg-pink"><i class="iconfont mallservice-daishouhuofuben"></i></div>
        <div class="describe">
